...
public class MemberJoinverifyEmailAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {

		String email =  request.getParameter("email"); //입력된 이메일 주소
		String domain =  request.getParameter("domain"); //입력된 이메일 주소
		String recipientemail = email + "@" + domain;
